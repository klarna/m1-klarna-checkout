...
class Klarna_Kco_Model_System_Config_Source_Customproductattributes
{
    const ENTITY_CODE_CUSTOMER = 'catalog_product';

    /**
     * Retrieve all user defined catalog product attributes as array
     *
     * @return array
     */
