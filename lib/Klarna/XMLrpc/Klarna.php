...
require_once 'SQLStorage.php';
require_once 'XMLStorage.php';
require_once 'JSONStorage.php';
require_once 'KlarnaAddr.php';
require_once 'KlarnaCalc.php';
require_once 'KlarnaConfig.php';
require_once 'KlarnaCountry.php';
require_once 'KlarnaCurrency.php';
require_once 'KlarnaEncoding.php';
require_once 'KlarnaException.php';
require_once 'KlarnaFlags.php';
require_once 'KlarnaLanguage.php';
require_once 'KlarnaPClass.php';
require_once 'Klarna/ArgumentNotSetException.php';
require_once 'Klarna/ConfigFieldMissingException.php';
require_once 'Klarna/DatabaseException.php';
require_once 'Klarna/FileNotReadableException.php';
require_once 'Klarna/FileNotWritableException.php';
require_once 'Klarna/IncompleteConfigurationException.php';
require_once 'Klarna/InvalidKlarnaAddrException.php';
require_once 'Klarna/InvalidLocaleException.php';
require_once 'Klarna/InvalidPNOException.php';
require_once 'Klarna/InvalidPriceException.php';
require_once 'Klarna/InvalidTypeException.php';
require_once 'Klarna/MissingAddressException.php';
require_once 'Klarna/MissingCountryException.php';
require_once 'Klarna/MissingGoodslistException.php';
require_once 'Klarna/PCStorageInvalidException.php';
require_once 'Klarna/PClassException.php';
require_once 'Klarna/ShippingCountryException.php';
require_once 'Klarna/UnknownAddressTypeException.php';
require_once 'Klarna/UnknownCountryException.php';
require_once 'Klarna/UnknownCurrencyException.php';
require_once 'Klarna/UnknownEncodingException.php';
require_once 'Klarna/UnknownLanguageException.php';
require_once 'Klarna/UnsupportedMarketException.php';
require_once 'Klarna/XMLParseException.php';
...
class Klarna
{
    ...
    public function __construct()
    {
        if (version_compare(Mage::getVersion(), '1.7', '<')) {
            $this->VERSION .= ':Magento:' . Mage::getVersion();
        } else {
            $this->VERSION .= ':Magento:' . Mage::getEdition() . ':' . Mage::getVersion();
        }

        $this->VERSION .= ':KcoModule:' . Mage::getConfig()->getModuleConfig('Klarna_Kco')->version;
        $this->VERSION .= ':KredModule:' . Mage::getConfig()->getModuleConfig('Klarna_KcoKred')->version;
    }
        ...
        if (isset($this->config['url'])) {
            ...
            if ($this->_url === false) {
                $message = "Configuration value 'url' could not be parsed. " .
                    "(Was: '{$this->config['url']}')";
                Klarna::storeDebug(__METHOD__, $message);
    ...
    public function setAddress($type, $addr)
    {
        ...
        if ($type === KlarnaFlags::IS_SHIPPING) {
            $this->shipping = $addr;
            self::storeDebug("shipping address array", $this->shipping);
        ...
        if ($type === KlarnaFlags::IS_BILLING) {
            $this->billing = $addr;
            self::storeDebug("billing address array", $this->billing);
    ...
    public function getAddresses(
        ...
        self::storeDebug("get_addresses array", $paramList);

        $result = $this->xmlrpc_call('get_addresses', $paramList);

        self::storeDebug("get_addresses result array", $result);
    ...
    public function addTransaction(
        ...
        self::storeDebug('add_invoice', $paramList);
        ...
        self::storeDebug('add_invoice result', $result);
    ...
    public function activateInvoice(
        ...
        self::storeDebug('activate_invoice', $paramList);
        ...
        self::storeDebug('activate_invoice result', $result);
    ...
    public function deleteInvoice($invNo)
    {
        ...
        self::storeDebug('delete_invoice', $paramList);
    ...
    public function reserveAmount(
        ...
        self::storeDebug('reserve_amount', $paramList);
        ...
        self::storeDebug('reserve_amount result', $result);
    ...
    public function extendExpiryDate($rno)
    {
        ...
        self::storeDebug('extend_expiry_date', $paramList);
    ...
    public function cancelReservation($rno)
    {
        ...
        self::storeDebug('cancel_reservation', $paramList);
    ...
    public function changeReservation(
        ...
        self::storeDebug('change_reservation', $paramList);
    ...
    public function update($rno, $clear = true)
    {
        ...
        self::storeDebug('update array', $paramList);

        $result = $this->xmlrpc_call('update', $paramList);

        self::storeDebug('update result', $result);
    ...
    public function activate(
        ...
        self::storeDebug('activate array', $paramList);

        $result = $this->xmlrpc_call('activate', $paramList);

        self::storeDebug('activate result', $result);
    ...
    public function activateReservation(
        ...
        self::storeDebug('activate_reservation', $paramList);
        ...
        self::storeDebug('activate_reservation result', $result);
    ...
    public function splitReservation(
        ...
        self::storeDebug('split_reservation array', $paramList);

        $result = $this->xmlrpc_call('split_reservation', $paramList);

        self::storeDebug('split_reservation result', $result);
    ...
    public function reserveOCR($no, $country = null)
    {
        ...
        self::storeDebug('reserve_ocr_nums array', $paramList);
    ...
    public function hasAccount($pno, $encoding = null)
    {
        ...
        self::storeDebug('has_account', $paramList);
    ...
    public function activatePart(
        ...
        self::storeDebug('activate_part artNos array', $this->artNos);
        ...
        self::storeDebug('activate_part array', $paramList);
        ...
        self::storeDebug('activate_part result', $result);
    ...
    public function invoiceAmount($invNo)
    {
        ...
        self::storeDebug('invoice_amount array', $paramList);
    ...
    public function updateOrderNo($invNo, $orderid)
    {
        ...
        self::storeDebug('update_orderno array', $paramList);
    ...
    public function emailInvoice($invNo)
    {
        ...
        self::storeDebug('email_invoice array', $paramList);
    ...
    public function sendInvoice($invNo)
    {
        ...
        self::storeDebug('send_invoice array', $paramList);
    ...
    public function returnAmount(
        ...
        self::storeDebug('return_amount', $paramList);
    ...
    public function creditInvoice($invNo, $credNo = "")
    {
        ...
        self::storeDebug('credit_invoice', $paramList);
    ...
    public function creditPart($invNo, $credNo = "")
    {
        ...
        self::storeDebug('credit_part', $paramList);
    ...
    public function updateGoodsQty($invNo, $artNo, $qty)
    {
        ...
        self::storeDebug('update_goods_qty', $paramList);
    ...
    public function updateChargeAmount($invNo, $type, $newAmount)
    {
        ...
        self::storeDebug('update_charge_amount', $paramList);
    ...
    public function invoiceAddress($invNo)
    {
        ...
        self::storeDebug('invoice_address', $paramList);
    ...
    public function invoicePartAmount($invNo)
    {
        ...
        self::storeDebug('invoice_part_amount', $paramList);
    ...
    public function checkOrderStatus($id, $type = 0)
    {
        ...
        self::storeDebug('check_order_status', $paramList);
    ...
    public function getCustomerNo($pno, $encoding = null)
    {
        ...
        self::storeDebug('get_customer_no', $paramList);
    ...
    public function setCustomerNo($pno, $custNo, $encoding = null)
    {
        ...
        self::storeDebug('set_customer_no', $paramList);
    ...
    public function removeCustomerNo($custNo)
    {
        ...
        self::storeDebug('remove_customer_no', $paramList);
    ...
    private function _fetchPClasses($storage, $country, $language, $currency)
    {
        ...
        self::storeDebug('get_pclasses array', $paramList);

        $result = $this->xmlrpc_call('get_pclasses', $paramList);

        self::storeDebug('get_pclasses result', $result);
    ...
    public function fetchPClasses(
        ...
        try {
            ...
            self::storeDebug('load pclasses', $e->getMessage());
        }
    ...
    public static function digest($data, $hash = null)
    {
        ...
        self::storeDebug('digest() using hash', $hash);
    ...
    /**
     * Stores debug information if debug is set to true.
     *
     ...
     * @return void
     */
    public static function storeDebug($msg, $mixed)
    {
        if (self::$debug) {
